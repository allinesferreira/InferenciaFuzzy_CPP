/* 
 * File:   PreparacaoBaseDeteccaoSAtaqueConhecido.cpp
 * Author: allinesf
 * 
...
PreparacaoBaseDeteccaoSAtaqueConhecido::PreparacaoBaseDeteccaoSAtaqueConhecido() {}

PreparacaoBaseDeteccaoSAtaqueConhecido::PreparacaoBaseDeteccaoSAtaqueConhecido(const PreparacaoBaseDeteccaoSAtaqueConhecido& orig) {}

PreparacaoBaseDeteccaoSAtaqueConhecido::~PreparacaoBaseDeteccaoSAtaqueConhecido() {}

void  PreparacaoBaseDeteccaoSAtaqueConhecido::PreProcessamentoAtaquesConhecidos(char nomeArquivoDeteccao[50]){
     ...
     * Fase1: Gera arquivo somente com ataques desconhecidos
     */
    
    gac.GeraArquivoAtaquesDesconhecidos(nomeArquivoDeteccao, "Etiquetas","kddcup.data_10_percent");
    ...
    */
    ...
    gac.RetornaVetorDeEtiquetasGerArqSemEtiqueta("AtaquesDesconhecidos", "AtaquesDesconhecidos_SEtiqueta");
    ...
    ut.TransformaCaracteristicaDeteccaoEmItem("AtaquesDesconhecidos_SEtiqueta", pertinencia);
    pertinencia.clear();
